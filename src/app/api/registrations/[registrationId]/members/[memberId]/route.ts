...
import { z } from "zod";
import { RegistrationMemberRole, RegistrationMemberStatus, RegistrationStatus } from "@/generated/prisma/enums";
...
export async function PATCH(request: Request, { params }: Context) {
  ...
  const isCaptain = member.registration.userId === user.id && member.role === RegistrationMemberRole.CAPTAIN;
