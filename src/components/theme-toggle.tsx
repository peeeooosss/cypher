...
export function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="flex items-center gap-sm border border-line bg-paper-soft px-md py-xs font-mono text-[0.7rem] uppercase tracking-[0.15em] text-ink transition-colors hover:border-accent hover:text-accent"
